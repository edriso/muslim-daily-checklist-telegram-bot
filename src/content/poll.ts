 ...
 *
 * القائمة ٩ بنودٍ — أقلُّ من حدّ تيليجرام (١٠) عمدًا تخفيفًا لثِقل
 * استبيانٍ يوميّ. قيام الليل أُفرِد ببندٍ مستقلٍّ (لا يُدمَج مع الضحى)
 * لأنّه عبادةٌ مستقلّةٌ بزمنها وأجرها ونيّتها، والدمج يُلبِّس التأشير.
 * وكلتا النافلتين صِيغتا «ولو ركعتين» على هَدْي «أحبُّ الأعمالِ إلى اللهِ
 * أدومُها وإن قلّ» — تشجيعًا للمداومة لا للمثاليّة. تمزج ثلاثة أبعاد
 * قصدًا: شعائر (أذكار/قرآن/سنن)،
